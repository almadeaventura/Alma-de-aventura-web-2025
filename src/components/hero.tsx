                  ...
                  <CardContent className="p-0">
                    <div className="relative w-full aspect-square">
                      ...
                      <div className="absolute inset-0 flex flex-col items-start justify-center text-left p-4">
                        <h2 className={cn("text-4xl font-bold text-white drop-shadow-md", slide.titleClassName)}>
                        ...
                        <Button asChild size="sm" className="mt-4 rounded-full px-5 font-bold transition-transform hover:scale-105">
